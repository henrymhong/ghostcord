  ...
  render() {
    return (
      <div className="FormCenter">
        <form className="FormFields" onSubmit={(e) => this.submitSignup(e)}>
          <div className="FormField">
            <label className="FormField__Label" htmlFor="signup-email-input">
              Email
            </label>
            <input
              autoComplete="email"
          ...
          <div className="FormField">
            <label className="FormField__Label" htmlFor="signup-name-input">
              Name
            </label>
            <input
              autoComplete="name"
          ...
          <div className="FormField">
            <label className="FormField__Label" htmlFor="signup-password-input">
              Password
            </label>
            <input
